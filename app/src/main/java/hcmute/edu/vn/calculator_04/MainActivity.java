...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btn0, btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8, btn9,
            btnDot, btnPlus, btnMinus, btnMultiple, btnDivide, btnEqual, btnC, btnAC;
    ...
    private void setListenerForViews() {
        ...
        btnAC.setOnClickListener(btnAC_OnClick);
    }
    ...
    private View.OnClickListener btnAC_OnClick = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            if (checkOperation())
                txtView1.setText("");
    ...
    private View.OnClickListener btnC_OnClick = new  View.OnClickListener(){
        ...
        public void onClick(View view) {
            if(txtView1.length()!=0)
                txtView1.setText(txtView1.getText().toString().substring(0, txtView1.length() - 1));
            else if (checkOperation()) {
                resetOperationFlag();
                txtView1.setText(txtView2.getText().toString().substring(0,txtView2.length()-3));
                txtView2.setText("");
            }
            else {
                txtView2.setText("");
